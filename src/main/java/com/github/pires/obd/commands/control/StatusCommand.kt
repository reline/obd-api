...
data class StatusCommand(val command: String = "01 01") : ObdCommand(command) {
     ...
     */
    lateinit var onboardTestResults: SparkIgnitionOnboardTests

    /** {@inheritDoc}  */
    override fun performCalculations() { // ignore first two bytes [hh hh] of the response
...
/*
        ...
        onboardTestResults = SparkIgnitionOnboardTests(
            ...
            OnboardTest(c and 0x8 == 8, d and 0x8 == 8),
            OnboardTest(c and 0x4 == 4, d and 0x4 == 4),
            OnboardTest(c and 0x2 == 2, d and 0x2 == 2),
            OnboardTest(c and 0x1 == 1, d and 0x1 == 1)
        )
    }
